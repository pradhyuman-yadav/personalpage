// app/chat/[chatId]/page.tsx (ChatPage - Server Component)
...
// Fetch initial chat data *within* the Server Component
...
export default async function ChatPage({ params }: ChatPageProps) {
    ...
    const initialMessages = await getChatHistory(chatId); // Fetch initial data
